...
#	wojewodztwa=['02','04']
	...
	for woj in wojewodztwa:
		...
		wojfile = urllib.request.urlopen(baseUrl+"/319_Pierwsze_glosowanie/"+woj)
		parseWoj(wojfile)

#	obwodfile = urllib.request.urlopen(baseUrl+"/321_protokol_komisji_obwodowej/1")
#	parseObwod(obwodfile)

#	gminafile = urllib.request.urlopen(baseUrl+"/319_Pierwsze_glosowanie/020101")
#	parseGmina(gminafile)
